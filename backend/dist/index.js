...
const cities = [
    {
        ...
        description: "Yangon is Myanmar's most populous city and its most important commercial centre.",
    },
    {
        id: 2,
        vector: [0.5, 0.2, 0.7, 0.3, 0.4, 0.9, 0.1, 0.5, 0.6, 0.8],
        payload: { city: "Mandalay", region: "Mandalay" },
        description: "Mandalay is the cultural and religious centre of Myanmar, with many historic sites.",
    },
    {
        id: 3,
        vector: [0.3, 0.6, 0.4, 0.8, 0.2, 0.1, 0.5, 0.7, 0.3, 0.6],
        payload: { city: "Naypyidaw", region: "Naypyidaw" },
        description: "Naypyidaw is the capital city of Myanmar, known for its wide roads and government buildings.",
    },
    {
        id: 4,
        vector: [0.6, 0.1, 0.3, 0.9, 0.7, 0.2, 0.4, 0.5, 0.8, 0.2],
        payload: { city: "Bago", region: "Bago" },
        description: "Bago is a historic city with many pagodas and rich Mon heritage.",
    },
    {
        id: 5,
        vector: [0.7, 0.2, 0.5, 0.4, 0.3, 0.6, 0.9, 0.1, 0.2, 0.5],
        payload: { city: "Pathein", region: "Ayeyarwady" },
        description: "Pathein is a major city in the Ayeyarwady region, known for its traditional umbrellas and rice production.",
    },
    {
        id: 6,
        vector: [0.1, 0.4, 0.6, 0.2, 0.5, 0.8, 0.3, 0.7, 0.9, 0.1],
        payload: { city: "Mawlamyine", region: "Mon" },
        description: "Mawlamyine is the capital of Mon State, famous for its colonial architecture and riverfront.",
    },
    {
        id: 7,
        vector: [0.2, 0.5, 0.7, 0.1, 0.3, 0.4, 0.8, 0.6, 0.2, 0.9],
        payload: { city: "Taunggyi", region: "Shan" },
        description: "Taunggyi is the capital of Shan State, known for its annual balloon festival and cool climate.",
    },
    {
        id: 8,
        vector: [0.3, 0.7, 0.2, 0.5, 0.6, 0.1, 0.4, 0.8, 0.9, 0.3],
        payload: { city: "Sittwe", region: "Rakhine" },
        description: "Sittwe is a port city in Rakhine State, located at the confluence of the Kaladan and Mayu rivers.",
    },
    {
        id: 9,
        vector: [0.4, 0.1, 0.8, 0.2, 0.7, 0.5, 0.3, 0.6, 0.4, 0.8],
        payload: { city: "Hpa-An", region: "Kayin" },
        description: "Hpa-An is the capital of Kayin State, famous for its limestone mountains and caves.",
    },
    {
        id: 10,
        vector: [0.5, 0.3, 0.1, 0.6, 0.8, 0.2, 0.7, 0.4, 0.5, 0.6],
        payload: { city: "Kengtung", region: "Shan" },
        description: "Kengtung is a scenic town in eastern Shan State, known for its ethnic diversity and traditional festivals.",
    },
];
